        ...
        fetch('https://hidden-dusk-12600.herokuapp.com/booking', {
            ...
            .then(data => {
                ...
                if (data.success) {
                    ...
                    toast(`You already have an appointment for ${data.booking?.date} at ${data.booking?.slot}`);
                }
                refetch();
                //to close the modal
                setTreatment(null);
        ...
        <div>
            ...
            <div className="modal modal-bottom sm:modal-middle">
                <div className="modal-box">
                    ...
                    <h3 className="font-bold text-lg text-center pb-3 text-secondary">Booking for: {name}</h3>
